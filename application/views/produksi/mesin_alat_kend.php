...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li>Setup</li>
        <li>Produksi</li>
        <li class="active">Mesin, Alat & Kend</li>
    </ol>
</section>
                ...
                <div class="">
                    ...
                    <form class="form-horizontal">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Kelompok Asset</label>
                            ...
                            <div class="form-group">
                                <label for="inputPassword3" class="col-sm-2 control-label">Status Alat</label>
