...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li>Setup</li>
        <li>Produksi</li>
        <li class="active">Lokasi Produksi</li>
    </ol>
</section>
                ...
                <div class="">
                    ...
                    <form class="form-horizontal">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Kode Perusahaan</label>
                            ...
                            <div class="form-group">
                                <label for="inputPassword3" class="col-sm-2 control-label">Nama PIC</label>
                            ...
                            <div class="form-group">
                                <label for="inputPassword3" class="col-sm-2 control-label">No HP PIC</label>
                            ...
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Status Lokasi</label>
