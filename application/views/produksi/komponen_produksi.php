...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li>Setup</li>
        <li>Produksi</li>
        <li class="active">Komponen Produksi</li>
    </ol>
</section>
                    ...
                    <form class="form-horizontal">
                        <div class="box-body">
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Kode Komponen</label>
                            ...
                            <div class="form-group">
                                <label for="inputPassword3" class="col-sm-2 control-label">Golongan Var</label>
                            ...
                            <div class="form-group">
                                <label for="inputPassword3" class="col-sm-2 control-label">Status Bahan Baku</label>
                            ...
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Status Komponen</label>
