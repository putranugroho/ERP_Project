...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li>Setup</li>
        <li>Produksi</li>
        <li class="active">Biaya Produksi</li>
    </ol>
</section>
                    ...
                    <form class="form-horizontal">
                        <div class="box-body">
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Kode Biaya</label>
                            ...
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Golongan Variable</label>
